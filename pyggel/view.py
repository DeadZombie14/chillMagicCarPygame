...
safeCheckError = oglError._ErrorChecker._getErrors
# safeCheckError = oglError._ErrorChecker._registeredChecker
...
def set_debug(boolean):
    ...
    if boolean:
        oglError._ErrorChecker._getErrors = safeCheckError
    else:
        oglError._ErrorChecker._getErrors = quickCheckError
    # if boolean:
    #     oglError._ErrorChecker._registeredChecker = safeCheckError
    # else:
    #     oglError._ErrorChecker._registeredChecker = quickCheckError
...
def set_near_far_view(near=0.1, far=100.0):
    screen.close_view = near
    screen.far_view = far

def set_view_angle(angle=45):
    screen.view_angle = angle
