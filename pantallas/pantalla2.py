...
class Pantalla2(App):
    ...
    def thorpy(self):
        ...
        self.slider = thorpy.SliderX.make(100, (12, 35), "My Slider")
        button = thorpy.make_button("Generar nueva pantalla", func= lambda: self.app.cambioDePantalla(2,self))
        
        # Encerrar elementos en una caja
        box = thorpy.Box.make(elements=[self.slider,button])
